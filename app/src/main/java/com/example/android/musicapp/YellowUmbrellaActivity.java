...
public class YellowUmbrellaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songsList.add(new Song(R.drawable.album, "I will always love you", "Whitney Huston", R.raw.song_three));
        songsList.add(new Song(R.drawable.album, "My heart will go on", "Céline Dion", R.raw.song_four));
        songsList.add(new Song(R.drawable.album, "Unforgettable", "Nat King Cole", R.raw.song_five));
        songsList.add(new Song(R.drawable.album, "You're the one that I want", "Grease", R.raw.song_one));
        songsList.add(new Song(R.drawable.album, "I've been loving you", "Otis Redding", R.raw.song_two));
        songsList.add(new Song(R.drawable.album, "Hymne à l'amour", "Edith Piaf", R.raw.song_three));
        songsList.add(new Song(R.drawable.album, "La déclaration d'amour", "France Gall", R.raw.song_two));
